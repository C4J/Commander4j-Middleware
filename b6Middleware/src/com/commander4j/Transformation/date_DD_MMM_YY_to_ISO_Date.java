...
public class date_DD_MMM_YY_to_ISO_Date extends ExtensionFunctionDefinition
{
	...
	{
		return new StructuredQName("c4j_XSLT_Ext", "http://com.commander4j.Transformation", "date_DD_MMM_YY_to_ISO_Date");
	}
