...
public class ISO_Date_to_date_DD_MM_YYYY_HH_MM_SS extends ExtensionFunctionDefinition
{
	...
	{
		return new StructuredQName("c4j_XSLT_Ext", "http://com.commander4j.Transformation", "ISO_Date_to_date_DD_MM_YYYY_HH_MM_SS");
	}
