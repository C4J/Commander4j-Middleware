...
public class ISO_Date_to_date_DDMMYYYY extends ExtensionFunctionDefinition
{
	...
	{
		return new StructuredQName("c4j_XSLT_Ext", "http://com.commander4j.Transformation", "ISO_Date_to_date_DDMMYYYY");
	}
	...
	public ExtensionFunctionCall makeCallExpression()
	{
	       return new ExtensionFunctionCall() {
	            ...
	            public Sequence call(XPathContext context, Sequence[] arguments) throws XPathException {
	        		...
	        		SimpleDateFormat myFormat = new SimpleDateFormat("ddMMyyyy", Locale.ENGLISH);
